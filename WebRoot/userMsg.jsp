...
<body>
  ...
  <div class="container nms">
    <div class="title">
      <h2>联系人</h2>
      <div class="action">
          <a class="btn btn-primary" href="#">创建新联系人</a>
          <a class="btn btn-inverse" href="#">批量导入</a>
      </div>
    </div>
    <div class="content">
      <table class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          <td>
              <a href="UserMsgServlet?type=del&id=${userMsg.id}" class="btn">删除</a>
              <a href="UserMsgServlet?type=edit&username=${userMsg.name}&tel=userMsg.phoneNumber&id=${userMsg.id}" class="btn">修改</a>
          </td>
        </tbody>
      </table>
      <!--分页-->
